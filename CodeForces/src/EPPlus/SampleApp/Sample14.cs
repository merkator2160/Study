...
namespace EPPlusSamples
{
    class Sample14
    {
        ...
        {
            var newFile = new FileInfo(outputDir.FullName + @"\sample14.xlsx");
            ...
            using (var package = new ExcelPackage(newFile))
            {
                ...
                // -------------------------------------------------------------------
                var cfAddress1 = new ExcelAddress("A2:A10");
                ...
                // -------------------------------------------------------------------
                var cfAddress2 = new ExcelAddress(2, 2, 10, 2);  //="B2:B10"
                ...
                // -------------------------------------------------------------------
                var timePeriodAddress = new ExcelAddress("D21:G34 C11:C20");
                ...
                // -------------------------------------------------------------------
                var cellIsAddress = new ExcelAddress("E11:E20");
                ...
                var cfAddress43 = new ExcelAddress("G2:G10");
                ...
                var cfAddress44 = new ExcelAddress("H2:H10");
