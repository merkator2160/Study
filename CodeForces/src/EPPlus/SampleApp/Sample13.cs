...
namespace EPPlusSamples
{
    ...
    public static class Sample13
    {
        public class FileDto
        {
            ...
            public Boolean IsDirectory = false;                  //This is a field variable
        ...
        public static void RunSample13(DirectoryInfo outputDir)
        {
            ...
            var dt = GetDataTable(outputDir.Root);
            ...
            var list = (from row in dt.Select()
                        select new FileDto
                        {
                            ...
                            Size = row["Size"].GetType() == typeof(Int64) ? (Int64)row["Size"] : 0,
