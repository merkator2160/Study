...
namespace EPPlusSamples
{
    ...
    class Sample11
    {
        public static String RunSample11(DirectoryInfo outputDir)
        {
            ...
            var output = new FileInfo(outputDir.FullName + @"\Output.xlsx");
            if (output.Exists)
            {
                output.Delete();
        ...
        private static void PrintWholeValidationDetails(ExcelWorksheet sheet, IExcelDataValidationInt wholeValidation, Int32 row)
        {
        ...
        private static void PrintListValidationDetails(ExcelWorksheet sheet, IExcelDataValidationList listValidation, Int32 row)
        {
        ...
        private static void PrintTimeValidationDetails(ExcelWorksheet sheet, ExcelDataValidationTime validation, Int32 row)
        {
