...
namespace EPPlusSamples
{
    public static class Sample10
    {
        public static void RunSample10(DirectoryInfo outputDir)
        {
            ...
            var templateFile = new FileInfo(outputDir.FullName + @"\Template.xlsx");
            if (templateFile.Exists)
            {
                templateFile.Delete();
                templateFile = new FileInfo(outputDir.FullName + @"\Template.xlsx");
            }
            var answerFile = new FileInfo(outputDir.FullName + @"\Answers.xlsx");
            ...
            var jkAnswerFile = new FileInfo(outputDir.FullName + @"\JKAnswers.xlsx");
